/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2018/11/21 14:42:09                          */
/*==============================================================*/
...
drop table if exists organization_publish;
...
alter table moral_score comment '品行基本表';

/*==============================================================*/
/* Table: organization_publish                                  */
/*==============================================================*/
create table organization_publish
(
   id                   int not null auto_increment,
   organization_id      int,
   activity_id          int,
...
alter table organization_publish comment '组织发布活动表';
...
alter table study_score comment '学业表现表';
