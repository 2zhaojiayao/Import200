							...
							<c:forEach items="${allActivity.list }" var="all" varStatus="s">
								<div class="bottom_list_detail">
									...
									<div class="bottom_list_detail_right">
										...
										<div class="operation">
											<a href="#">编辑活动</a> <a href="toparticipationall?activityid=${all[4] }">参与详情</a> <a href="#">删除活动</a>
										</div>
									</div>
								</div>
								<div class="clear"></div>
							...
							<c:forEach items="${beforeActivity.list }" var="ba" varStatus="s">
								<div class="bottom_list_detail">
									...
									<div class="bottom_list_detail_right">
										...
										<div class="operation">
											<a href="#">编辑活动</a> <a href="toparticipationall?activityid=${ba[0] }">参与详情</a> <a href="#">删除活动</a>
										</div>
									</div>
								</div>
								<div class="clear"></div>
							...
							<c:forEach items="${inActivity.list }" var="ia" varStatus="s">
								<div class="bottom_list_detail">
									...
									<div class="bottom_list_detail_right">
										...
										<div class="operation">
											<a href="#">编辑活动</a> <a href="toparticipationia?activityid=${ia[0] }">参与详情</a> <a href="#">删除活动</a>
										</div>
									</div>
								</div>
								<div class="clear"></div>
							...
							<c:forEach items="${afterActivity.list }" var="aa" varStatus="s">
								<div class="bottom_list_detail">
									...
									<div class="bottom_list_detail_right">
										...
										<div class="operation">
											<a href="#">编辑活动</a> <a href="toparticipationaa?activityid=${aa[0] }">参与详情</a> <a href="#">删除活动</a>
										</div>
									</div>
								</div>
								<div class="clear"></div>
