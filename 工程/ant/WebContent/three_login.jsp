		...
		<div class="login_form l_float">
			...
			<div class="login_top">
				...
				<div class="login_tags b_clear">
					...
					<span class="top_tag m_float" onClick="QrcodeLogin()">班委登录</span> <span
						class="top_tag r_float" onClick="OgniLogin()">组织登录</span>
				</div>
			</div>
			<div class="login_con">
				<form action="stu_login" method="POST">
					...
					<div>
						<label for="user_pwd">密码</label> <input type="password" name="pwd"
			...
			<div class="login_con hidden">
				<form action="mon_login" method="POST">
					<div>
						<label for="user_name">用户名</label> <input type="text" name="email"
